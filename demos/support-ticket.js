...
const flowsMenu = [
  {
    ...
    steps: [
      { type: "SAY",     id: "say_1",     value: "Sure — let's open a support ticket." },
      ...
      {
        type: "SAY", id: "say_2", value: "Ticket created: {{ticket_result.ticket.id}} — we'll email updates to {{ticket_result.ticket.customer_email}}."
      }
    ]
  }
];
